...
We next examine the distribution of our outcome variable, ppm (price per mg). We can see that ppm spans a large range of values, from \$0.00025/mg to \$40/mg.

```{r}
ggplot(data = streetrx, aes(x = ppm)) + 
  geom_histogram(color = "white") + 
  labs(y = "", 
       title = "Distribution of price per mg (ppm) of Methadone")

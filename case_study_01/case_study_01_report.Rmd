...
Region: $r$. State: $s$. 
$$y_{isr} = \mu + \alpha_{sr} + \alpha_{r} + \epsilon_{ij}.$$

Why include both regional level and state level random intercepts?
...
Order: step-wise forward? May not find the optimum. Think of a good way to find a decent model.
...
summary(bayes_result)$random

summary(bayes_result)$spec_pars %>%
  select("Estimate")
...
One can see that the results given by Bayesian setting is almost the same as that from the frequentist setting.

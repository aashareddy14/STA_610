...
- fixed effects: `sex_code`, `age`, `voted_party_cd`
- interactions: `sex_code:voted_party_cd`, `age:voted_party_cd`

EXHAUSTIVE SEARCH: add potential covariates into BASE MODEL
- `race_code`, `ethnic_code`, `sex_code:age`, `voted_party_cd:race_code`
...
```{r, echo = F}
ex_result_int <- readRDS("ex_result_int.RDS")

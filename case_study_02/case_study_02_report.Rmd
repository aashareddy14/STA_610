...
- [Aasha] Change party_cd to voted_party_cd
- [Aasha] Double check missing data for race
- [Aasha] Add comment on the assumption for total_registered < total_voters
- [Aasha] Check whether missing pattern has something to do with other columns. WE can still remove missing data but look into rationale for doing so. - There are no 0s in the voted dataset, so we can just impute 0 for NAs 
- [Aasha] Check how many missing observations are in new dataset
- [Aasha] Make plots for random slopes
...
The final dataset after sampling 30 counties has 13,080 observations after deleting missing values.
...
- put some plots for random slopes

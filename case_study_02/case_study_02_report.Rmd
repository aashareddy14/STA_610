...
- [Bo] Make sure male is baseline level for sex_code
- [Bo] Exhaustive search for model selection
- [Bo] Update the model specification
...
$$
y_{ij} \mid \pi_{ij} \stackrel{\mathrm{iid}}{\sim} \mathrm{Bin}(N_{ij}, \pi_{ij}),
\quad
\mathrm{logit}(
\pi_{ij}
...
- exhaustive search: all fixed effects and interactions 

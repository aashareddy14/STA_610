...
- [Bo] Make sure male is baseline level for sex_code (Did not do this - what is the reason?)
- Start with frequentist model and then Bayesian model after (put other in appendix)
- [Marc] Interpretation of frequentist
- [Shirley] Bayesian modeling
- [Aasha] putting slides together
- Model assessment (ROC curves, etc.)
